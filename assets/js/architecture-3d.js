...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function $d(){return new Mt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Bl(),fragmentShader:`
		...
		`,blending:Tn,depthTest:!1,depthWrite:!1})}function jd(){return new Mt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Bl(),fragmentShader:`
	...
	`}var Fl=class extends It{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Or(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new qe(l,c),d=new Sn(-1,1,1,-1,0,1),u=null,f=null,g=!1,y,m=null,p=[],w=!1;this.setSize=function(E,v){a.setSize(E,v),o.setSize(E,v);for(let T=0;T<p.length;T++){let S=p[T];S.setSize&&S.setSize(E,v)}},this.setEffects=function(E){p=E,w=p.length>0&&p[0].isRenderPass===!0;let v=a.width,T=a.height;for(let S=0;S<p.length;S++){let R=p[S];R.setSize&&R.setSize(v,T)}},this.begin=function(E,v){if(g||E.toneMapping===Bn&&p.length===0)return!1;if(m=v,v!==null){let T=v.width,S=v.height;(a.width!==T||a.height!==S)&&this.setSize(T,S)}return w===!1&&E.setRenderTarget(a),y=E.toneMapping,E.toneMapping=Bn,!0},this.hasRenderPass=function(){return w},this.end=function(E,v){E.toneMapping=y,g=!0;let T=a,S=o;for(let R=0;R<p.length;R++){let x=p[R];if(x.enabled!==!1&&(x.render(E,S,T,v),x.needsSwap!==!1)){let b=T;T=S,S=b}}if(u!==E.outputColorSpace||f!==E.toneMapping){u=E.outputColorSpace,f=E.toneMapping,c.defines={},Be.getTransfer(u)===Ye&&(c.defines.SRGB_TRANSFER="");let R=h0[f];R&&(c.defines[R]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=T.texture,E.setRenderTarget(m),E.render(h,d),m=null,g=!1},this.isCompositing=function(){return g},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}var yf=new Bt,yh=new hi(1,1),vf=new Cr,Mf=new Mo,Sf=new Or,Qd=[],ef=[],tf=new Float32Array(16),nf=new Float32Array(9),sf=new Float32Array(4);function ar(i,e,t){let n=i[0];if(n<=0||n>0)return i;let s=e*t,r=Qd[s];if(r===void 0&&(r=new Float32Array(s),Qd[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Lt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Dt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function zl(i,e){let t=ef[e];t===void 0&&(t=new Int32Array(e),ef[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function d0(i,e){let t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function f0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;i.uniform2fv(this.addr,e),Dt(t,e)}}function p0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Lt(t,e))return;i.uniform3fv(this.addr,e),Dt(t,e)}}function m0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;i.uniform4fv(this.addr,e),Dt(t,e)}}function g0(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Lt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,n))return;sf.set(n),i.uniformMatrix2fv(this.addr,!1,sf),Dt(t,n)}}function _0(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Lt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,n))return;nf.set(n),i.uniformMatrix3fv(this.addr,!1,nf),Dt(t,n)}}function x0(i,e){let t=this.cache,n=e.elements;if(n===void 0){if(Lt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,n))return;tf.set(n),i.uniformMatrix4fv(this.addr,!1,tf),Dt(t,n)}}function y0(i,e){let t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function v0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;i.uniform2iv(this.addr,e),Dt(t,e)}}function M0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;i.uniform3iv(this.addr,e),Dt(t,e)}}function S0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;i.uniform4iv(this.addr,e),Dt(t,e)}}function b0(i,e){let t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function T0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;i.uniform2uiv(this.addr,e),Dt(t,e)}}function E0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;i.uniform3uiv(this.addr,e),Dt(t,e)}}function A0(i,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;i.uniform4uiv(this.addr,e),Dt(t,e)}}function w0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(yh.compareFunction=t.isReversedDepthBuffer()?Dl:Ll,r=yh):r=yf,t.setTexture2D(e||r,s)}function R0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Mf,s)}function C0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Sf,s)}function P0(i,e,t){let n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||vf,s)}function I0(i){switch(i){case 5126:return d0;case 35664:return f0;case 35665:return p0;case 35666:return m0;case 35674:return g0;case 35675:return _0;case 35676:return x0;case 5124:case 35670:return y0;case 35667:case 35671:return v0;case 35668:case 35672:return M0;case 35669:case 35673:return S0;case 5125:return b0;case 36294:return T0;case 36295:return E0;case 36296:return A0;case 35678:case 36198:case 36298:case 36306:case 35682:return w0;case 35679:case 36299:case 36307:return R0;case 35680:case 36300:case 36308:case 36293:return C0;case 36289:case 36303:case 36311:case 36292:return P0}}function L0(i,e){i.uniform1fv(this.addr,e)}function D0(i,e){let t=ar(e,this.size,2);i.uniform2fv(this.addr,t)}function N0(i,e){let t=ar(e,this.size,3);i.uniform3fv(this.addr,t)}function U0(i,e){let t=ar(e,this.size,4);i.uniform4fv(this.addr,t)}function F0(i,e){let t=ar(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function O0(i,e){let t=ar(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function B0(i,e){let t=ar(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function z0(i,e){i.uniform1iv(this.addr,e)}function k0(i,e){i.uniform2iv(this.addr,e)}function V0(i,e){i.uniform3iv(this.addr,e)}function H0(i,e){i.uniform4iv(this.addr,e)}function G0(i,e){i.uniform1uiv(this.addr,e)}function W0(i,e){i.uniform2uiv(this.addr,e)}function X0(i,e){i.uniform3uiv(this.addr,e)}function q0(i,e){i.uniform4uiv(this.addr,e)}function Y0(i,e,t){let n=this.cache,s=e.length,r=zl(t,s);Lt(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=yh:a=yf;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function Z0(i,e,t){let n=this.cache,s=e.length,r=zl(t,s);Lt(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||Mf,r[a])}function K0(i,e,t){let n=this.cache,s=e.length,r=zl(t,s);Lt(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Sf,r[a])}function J0(i,e,t){let n=this.cache,s=e.length,r=zl(t,s);Lt(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||vf,r[a])}function $0(i){switch(i){case 5126:return L0;case 35664:return D0;case 35665:return N0;case 35666:return U0;case 35674:return F0;case 35675:return O0;case 35676:return B0;case 5124:case 35670:return z0;case 35667:case 35671:return k0;case 35668:case 35672:return V0;case 35669:case 35673:return H0;case 5125:return G0;case 36294:return W0;case 36295:return X0;case 36296:return q0;case 35678:case 36198:case 36298:case 36306:case 35682:return Y0;case 35679:case 36299:case 36307:return Z0;case 35680:case 36300:case 36308:case 36293:return K0;case 36289:case 36303:case 36311:case 36292:return J0}}var vh=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=I0(t.type)}},Mh=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=$0(t.type)}},Sh=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(e,t[o.id],n)}}},_h=/(\w+)(\])?(\[|\.)?/g;function rf(i,e){i.seq.push(e),i.map[e.id]=e}function j0(i,e,t){let n=i.name,s=n.length;for(_h.lastIndex=0;;){let r=_h.exec(n),a=_h.lastIndex,o=r[1],l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){rf(t,c===void 0?new vh(o,i,e):new Mh(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new Sh(o),rf(t,d)),t=d}}}var sr=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){let o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);j0(o,l,this)}let s=[],r=[];for(let a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){let r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){let s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){let o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){let n=[];for(let s=0,r=e.length;s!==r;++s){let a=e[s];a.id in t&&n.push(a)}return n}};function af(i,e,t){let n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}var Q0=37297,ex=0;function tx(i,e){let t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){let o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}var of=new De;function nx(i){Be._getMatrix(of,Be.workingColorSpace,i);let e=`mat3( ${of.elements.map(t=>t.toFixed(4))} )`;switch(Be.getTransfer(i)){case wr:return[e,"LinearTransferOETF"];case Ye:return[e,"sRGBTransferOETF"];default:return Me("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function lf(i,e,t){let n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";let a=/ERROR: 0:(\d+)/.exec(r);if(a){let o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}var sx={[aa]:"Linear",[oa]:"Reinhard",[la]:"Cineon",[cs]:"ACESFilmic",[ha]:"AgX",[ua]:"Neutral",[ca]:"Custom"};function rx(i,e){let t=sx[e];return t===void 0?(Me("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Ul=new C;function ax(){Be.getLuminanceCoefficients(Ul);let i=Ul.x.toFixed(4),e=Ul.y.toFixed(4),t=Ul.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ox(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ta).join(`
`)}function lx(i){let e=[];for(let t in i){let n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function cx(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(e,s),a=r.name,o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ta(i){return i!==""}function cf(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function hf(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var hx=/^[ \t]*#include +<([\w\d./]+)>/gm;function bh(i){return i.replace(hx,dx)}var ux=new Map;function dx(i,e){let t=ke[e];if(t===void 0){let n=ux.get(e);if(n!==void 0)t=ke[n],Me('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return bh(t)}var fx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function uf(i){return i.replace(fx,px)}function px(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function df(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}var mx={[sa]:"SHADOWMAP_TYPE_PCF",[js]:"SHADOWMAP_TYPE_VSM"};function gx(i){return mx[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var _x={[ki]:"ENVMAP_TYPE_CUBE",[hs]:"ENVMAP_TYPE_CUBE",[da]:"ENVMAP_TYPE_CUBE_UV"};function xx(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":_x[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var yx={[hs]:"ENVMAP_MODE_REFRACTION"};function vx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":yx[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var Mx={[Xo]:"ENVMAP_BLENDING_MULTIPLY",[Pd]:"ENVMAP_BLENDING_MIX",[Id]:"ENVMAP_BLENDING_ADD"};function Sx(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Mx[i.combine]||"ENVMAP_BLENDING_NONE"}function bx(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Tx(i,e,t,n){let s=i.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,l=gx(t),c=xx(t),h=vx(t),d=Sx(t),u=bx(t),f=ox(t),g=lx(r),y=s.createProgram(),m,p,w=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);let E=w+m+a,v=w+p+o,T=af(s,s.VERTEX_SHADER,E),S=af(s,s.FRAGMENT_SHADER,v);s.attachShader(y,T),s.attachShader(y,S),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function R(P){if(i.debug.checkShaderErrors){let U=s.getProgramInfoLog(y)||"",W=s.getShaderInfoLog(T)||"",q=s.getShaderInfoLog(S)||"",O=U.trim(),G=W.trim(),H=q.trim(),$=!0,Q=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if($=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,T,S);else{let ue=lf(s,T,"vertex"),me=lf(s,S,"fragment");Pe("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};var Jl=class extends gn{constructor(){super(),this.isOutputPass=!0,this.uniforms=_i.clone(wa.uniforms),this.material=new Ks({name:wa.name,uniforms:this.uniforms,vertexShader:wa.vertexShader,fragmentShader:wa.fragmentShader}),this._fsQuad=new Xi(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Be.getTransfer(this._outputColorSpace)===Ye&&(this.material.defines.SRGB_TRANSFER=""),this._toneMapping===aa?this.material.defines.LINEAR_TONE_MAPPING="":this._toneMapping===oa?this.material.defines.REINHARD_TONE_MAPPING="":this._toneMapping===la?this.material.defines.CINEON_TONE_MAPPING="":this._toneMapping===cs?this.material.defines.ACES_FILMIC_TONE_MAPPING="":this._toneMapping===ha?this.material.defines.AGX_TONE_MAPPING="":this._toneMapping===ua?this.material.defines.NEUTRAL_TONE_MAPPING="":this._toneMapping===ca&&(this.material.defines.CUSTOM_TONE_MAPPING=""),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};var ln=document.querySelector("#architecture-demo"),Ie=i=>ln.querySelector(i),Ca=Ie("#scene-view"),ur=Ie("#architecture-canvas"),wn=matchMedia("(prefers-reduced-motion: reduce)"),Uf=wn.matches,Vn=new URLSearchParams(location.search).get("capture")==="1";Vn&&document.body.classList.add("capture");var Zt,An,_n,bt,Rt,dr,Ra,fr=!1,Hn=!1,yi=!1,xi=!1,uu=1,zt=0,tt,jl=-1,Pa="",$l=0,ou=0,pr=!1,lu=new Map,Ia=new Map,Ql=new Map,kf=new Map,Ty=[],cu=new Map,hu="",ms=new ye("#ffffff"),Ey=new ye("#ff746d"),Ff=new C,au=new C,Vf=new C(14,20,24),ec=new C(0,.3,.5),Ay={active:"IN PROGRESS",review:"REVIEW",denied:"DENIED",failed:"FAILED",hold:"HOLD"};function vi(){return tt?.steps.reduce((i,e)=>i+e.duration,0)||0}function ni(){if(!tt)return{step:{node:"",routes:[]},index:0,local:0};let i=zt;for(let e=0;e<tt.steps.length;e++){if(i<tt.steps[e].duration||e===tt.steps.length-1)return{step:tt.steps[e],index:e,local:i};i-=tt.steps[e].duration}}function Hf(i){return tt.steps.slice(0,i).reduce((e,t)=>e+t.duration,0)}function Of(i){return`${String(Math.floor(i/60)).padStart(2,"0")}:${String(Math.floor(i%60)).padStart(2,"0")}`}function Rn(i){Hn=!!i&&!wn.matches&&!pr&&fr,Hn&&zt>=vi()&&(zt=0),La()}function La(){let i=Ie("[data-play]");i.textContent=Hn?"\u2161 Pause story":zt>=vi()?"\u21BB Replay story":"\u25B6 Play story",i.setAttribute("aria-pressed",String(Hn)),i.disabled=wn.matches||pr||!fr,i.title=wn.matches?"Reduced motion is enabled. Use the stage arrows or timeline.":"",Ie("[data-cinematic]").setAttribute("aria-pressed",String(yi)),Ie("[data-cinematic]").disabled=wn.matches||pr}function du(i){tt=Zt.scenarios.find(t=>t.id===i)||Zt.scenarios[0],zt=0,jl=-1,Gf(),Ie("[data-scenario-label]").textContent=tt.title.toUpperCase(),Ie("[data-progress-label]").textContent=`Stage 1 of ${tt.steps.length}`,Ie("#story-progress").max=vi(),ln.querySelectorAll("[data-scenario]").forEach(t=>t.setAttribute("aria-pressed",String(t.dataset.scenario===tt.id)));let e=new URL(location.href);e.searchParams.set("scenario",tt.id),e.searchParams.delete("component"),history.replaceState(null,"",e),Rn(!Vn),Mi(!0),Kt()}function fu(i){let e=Zt.nodes.find(r=>r.id===i);if(!e){if(Gf(),!Vn){let r=new URL(location.href);r.searchParams.delete("component"),history.replaceState(null,"",r)}tc();return}Pa=i,Ie("#component-select").value=i,Ie("[data-component-detail]").textContent=e.technicalTitle+": "+e.detail;let t=Ie("[data-component-source]");t.href=new URL(`../../docs/industry/library/#${e.sources.split(",")[0]}`,location.href).href,t.textContent=`Design basis \xB7 ${e.sources.split(",").join(" / ")} \u2197`;let n=Ie("[data-component-definition]"),s=document.querySelector("[data-component-definitions]").content.querySelector(`[data-node="${i}"]`);if(n.hidden=!s,s&&(n.href=s.href,n.textContent=`Dictionary: ${s.textContent} \u2197`,n.setAttribute("aria-label",`Dictionary: ${s.textContent} (opens in a new tab)`)),!Vn){let r=new URL(location.href);r.searchParams.set("component",i),history.replaceState(null,"",r)}tc()}function Gf(){Pa="",Ie("#component-select").value="",Ie("[data-component-detail]").textContent="Choose a module in the scene or from this list to inspect its role.",Ie("[data-component-definition]").hidden=!0;let i=Ie("[data-component-source]");i.href=new URL("../../docs/industry/architecture/",location.href).href,i.textContent="Design basis & sources \u2197"}function Bf(){let i=new URLSearchParams(location.search),e=i.get("component"),t=Zt.nodes.find(s=>s.id===e),n=i.get("scenario")||t&&Zt.scenarios.find(s=>s.steps.some(r=>r.node===e))?.id||"generate";if(du(n),t&&!Vn){let s=tt.steps.findIndex(r=>r.node===e);zt=Hf(Math.max(0,s)),Mi(!0),fu(e),Rn(!1),Kt()}}function tc(){if(!Ra||!tt)return;hu="";let{step:i,index:e}=ni(),t=["denied","failed"].includes(i.state),n=t?Ey:ms,s=new Set([i.node,Pa,...i.routes.flatMap(r=>r.split(":"))]);for(let[r,a]of kf)a.material.color.copy(n),a.material.emissive.copy(n),a.visible=r===i.node,a.material.emissiveIntensity=.7;for(let[r,a]of Ql)a.dataset.active=String(r===i.node),a.dataset.inspected=String(r===Pa),a.dataset.alert=String(r===i.node&&t),a.hidden=!xi&&!s.has(r),a.querySelector(".node-step").textContent=r===i.node?String(e+1):"";for(let[r,a]of Ia){let o=i.routes.includes(r);a.base.visible=xi&&!o,a.highlight.visible=o,a.arrow.visible=o||xi,a.arrow.scale.setScalar(o?1.4:.75),a.arrow.material.color.copy(o?n:new ye("#8090a6")),a.packet.visible=o,a.packet.material.color.copy(n),a.packet.material.emissive.copy(n),a.highlight.material.color.copy(n),a.highlight.material.emissive.copy(n)}ln.dataset.overview=String(xi),ln.dataset.activeNode=i.node,ln.dataset.activeRoutes=i.routes.join(",")}function Mi(i=!1){if(!tt)return;let{step:e,index:t}=ni();if(i||t!==jl){jl=t,Ie("[data-step-number]").replaceChildren(document.createTextNode(String(t+1).padStart(2,"0")+" "));let n=document.createElement("span");n.textContent="/ "+String(tt.steps.length).padStart(2,"0"),Ie("[data-step-number]").append(n),Ie("[data-step-title]").textContent=e.title,Ie("[data-step-body]").textContent=e.body,Ie("[data-flow-summary]").textContent=e.flow,Ie("[data-artifact]").textContent=e.artifact,Ie("[data-state]").textContent=Ay[e.state],Ie("[data-state]").dataset.state=e.state,Ie("[data-announcement]").textContent=`${tt.title}. Stage ${t+1} of ${tt.steps.length}: ${e.title}. ${e.body}`,Ie("[data-progress-label]").textContent=`Stage ${t+1} of ${tt.steps.length}`,ln.dataset.stage=String(t),tc()}Ie("[data-time]").textContent=`${Of(zt)} / ${Of(vi())}`,Ie("#story-progress").value=zt,Ie("[data-previous]").disabled=t===0,Ie("[data-next]").disabled=t===tt.steps.length-1,Ie("[data-run-label]").textContent=Vn?"GUIDED ARCHITECTURE FILM":wn.matches?"REDUCED MOTION \xB7 STEP THROUGH":Hn?"GUIDED DEMONSTRATION":zt>=vi()?"STORY COMPLETE \xB7 REPLAY AVAILABLE":"PAUSED \xB7 EXPLORE THE ARCHITECTURE"}function zf(){if(!An)return;let i=Ca.clientWidth,e=Ca.clientHeight;An.setSize(i,e,!1),dr?.setSize(i,e);let t=Math.max(Vn?13.3:12.5,7.8*i/e),n=t*e/i;bt.left=-t,bt.right=t,bt.top=n,bt.bottom=-n,bt.updateProjectionMatrix(),Kt()}function wy(){bt&&(bt.position.copy(Vf),Rt.target.copy(ec),bt.lookAt(ec),Rt.update(),Kt())}function Kt(){if(!An||!tt||pr)return;let{step:i,local:e}=ni();if(yi&&!wn.matches){let t=zt/vi();bt.position.set(14+Math.sin(t*Math.PI*2)*2.1,20,24-Math.sin(t*Math.PI*2)*1.2);let n=Zt.nodes.find(s=>s.id===i.node).position;Rt.target.set(n[0]*.1,.3,.5+n[2]*.07),bt.lookAt(Rt.target)}Rt.update();for(let t of Ia.values()){if(!t.packet.visible)continue;let n=e%3.5/3.5;t.packet.position.copy(t.curve.getPointAt(n)),t.packet.scale.setScalar(1)}bt.updateMatrixWorld(),Ry(),dr.render(),ln.dataset.renderFrame=String(Number(ln.dataset.renderFrame||0)+1)}function Ry(){let i=Ca.clientWidth,e=Ca.clientHeight,t=[],n=[i,e,ni().index,xi,Pa,bt.zoom,...bt.position.toArray(),...Rt.target.toArray()].join(":");if(n===hu)return;hu=n;let s=ni().step.routes.flatMap(a=>Ia.get(a).curve.getPoints(50).map(o=>(o.project(bt),{x:(o.x*.5+.5)*i,y:(-o.y*.5+.5)*e}))),r=[...Ql].filter(([,a])=>!a.hidden).sort(([a],[o])=>(o===ni().step.node)-(a===ni().step.node));for(let[a,o]of Ql)o.hidden&&(cu.get(a).hidden=!0);for(let[a,o]of r){let l=Zt.nodes.find(E=>E.id===a);au.set(l.position[0],.4,l.position[2]+1.65).project(bt);let c=(au.x*.5+.5)*i,h=(-au.y*.5+.5)*e,d=o.offsetWidth,u=o.offsetHeight,f=(E,v,T)=>Math.max(v,Math.min(T,E)),g,y=1/0;for(let E of[0,38,-38,76,-76,114,-114,152,-152])for(let v of[0,-d*.6,d*.6,-d,d]){let T=f(c+v,d/2+10,i-d/2-10),S=f(h+E,55+u/2,e-48-u/2),R={left:T-d/2-5,right:T+d/2+5,top:S-u/2-4,bottom:S+u/2+4},x=t.filter(P=>R.left<P.right&&R.right>P.left&&R.top<P.bottom&&R.bottom>P.top).length,b=s.some(P=>P.x>R.left&&P.x<R.right&&P.y>R.top&&P.y<R.bottom),I=x*1e5+(b?4e3:0)+Math.hypot(T-c,S-h)+(E<0?4:0);I<y&&(y=I,g={x:T,y:S,r:R})}t.push(g.r),o.style.left=`${g.x}px`,o.style.top=`${g.y}px`,o.style.visibility="visible";let m=cu.get(a),p=g.x-c,w=g.y-h;m.hidden=!1,m.style.left=`${c}px`,m.style.top=`${h}px`,m.style.width=`${Math.hypot(p,w)}px`,m.style.transform=`rotate(${Math.atan2(w,p)}rad)`}}function Wf(i){if(requestAnimationFrame(Wf),Vn||!fr||document.hidden)return;qf();let e=$l?Math.min((i-$l)/1e3,.1):0;$l=i,Hn&&(zt=Math.min(vi(),zt+e*uu),zt>=vi()&&Rn(!1)),i-ou>80&&(Mi(),ou=i),(Hn||Rt.enableDamping)&&Kt()}function Xf(i){console.error("Architecture demo unavailable:",i),pr=!0,Rn(!1),Ie(".scene-loading").hidden=!0,Ie(".scene-fallback").hidden=!1,ln.dataset.status="fallback",Ie("[data-announcement]").textContent="3D rendering is unavailable. The stage descriptions and film remain available."}function Cy(){let i=new en({color:"#65758c",metalness:0,roughness:.8,emissive:"#65758c",emissiveIntensity:.05});for(let e of Zt.routes){let t=new Hr;for(let l=1;l<e.points.length;l++)t.add(new Ys(new C(...e.points[l-1]),new C(...e.points[l])));let n=new Zs(t,Math.max(16,e.points.length*12),.035,6,!1),s=new qe(n,i);_n.add(s);let r=new qe(new Zs(t,Math.max(16,e.points.length*12),.085,8,!1),new en({color:ms,emissive:ms,emissiveIntensity:.5,roughness:.28}));_n.add(r);let a=new qe(new zr(.115,.29,8),new Qt({color:"#6aaf9e"}));a.position.copy(t.getPointAt(.95)),Ff.copy(t.getTangentAt(.95)).normalize(),a.quaternion.setFromUnitVectors(new C(0,1,0),Ff),_n.add(a);let o=new qe(new Wr(.18,16,8),new en({color:ms,emissive:ms,emissiveIntensity:1.8,roughness:.16}));_n.add(o),Ia.set(e.id,{curve:t,base:s,highlight:r,arrow:a,packet:o})}}async function Py(){try{Zt=await(await fetch(ln.dataset.story)).json();for(let o of Zt.groups){let l=document.createElement("span");l.style.setProperty("--role-color",o.color);let c=document.createElement("b");c.textContent=o.badge,l.append(c,document.createTextNode(o.title)),Ie("[data-role-legend]").append(l)}for(let o of Zt.nodes){let l=document.createElement("option");l.value=o.id,l.textContent=o.title+" \xB7 "+o.technicalTitle,Ie("#component-select").append(l)}if(tt=Zt.scenarios[0],new URLSearchParams(location.search).has("no3d"))throw new Error("Static fallback preview");An=new Ol({canvas:ur,antialias:!0,alpha:!0,powerPreference:"high-performance"}),An.setPixelRatio(Vn?1:Math.min(devicePixelRatio,1.75)),An.setClearColor(597801,0),An.shadowMap.enabled=!0,An.shadowMap.type=Wo,An.toneMapping=cs,An.toneMappingExposure=.95,_n=new ss,bt=new Sn(-14,14,9,-9,.1,100),bt.position.copy(Vf),bt.lookAt(ec),Rt=new Wl(bt,ur),Rt.enableDamping=!Vn&&!wn.matches,Rt.dampingFactor=.1,Rt.enablePan=!1,Rt.minZoom=.75,Rt.maxZoom=2.8,Rt.minPolarAngle=.4,Rt.maxPolarAngle=1.16,Rt.target.copy(ec),Rt.addEventListener("start",()=>{yi=!1,La()}),Rt.addEventListener("change",()=>{Hn||(ou=0)});let i=new rr(An);_n.environment=i.fromScene(new Xl,.03).texture,_n.environmentIntensity=.22,i.dispose(),_n.add(new Jr("#c5e6dd","#133641",.8));let e=new Oi("#fff0ce",2);e.position.set(-6,16,10),e.castShadow=!0,e.shadow.mapSize.set(1024,1024),Object.assign(e.shadow.camera,{left:-14,right:14,top:13,bottom:-13,near:.1,far:50}),e.shadow.bias=-6e-4,e.shadow.normalBias=.025,_n.add(e);let t=new Oi("#77cfc3",1);t.position.set(6,8,-10),_n.add(t),Ra=(await new kl().loadAsync(ln.dataset.model)).scene,Ra.traverse(o=>{o.userData.nodeId&&lu.set(o.userData.nodeId,o),o.isMesh&&(o.castShadow=!0,o.receiveShadow=!0,o.material.envMapIntensity=.35,["Deep ceramic","Plinth basalt"].includes(o.material.name)&&(o.material.metalness=.15,o.material.roughness=.62),Ty.push(o.material))}),_n.add(Ra);for(let o of Zt.nodes){let l=Zt.groups.find(y=>y.id===o.group),c=document.createElement("span");c.className="scene-label",c.dataset.node=o.id,c.style.setProperty("--role-color",l.color);let h=document.createElement("b");h.className="node-role",h.textContent=l.badge;let d=document.createElement("span");d.textContent=o.title;let u=document.createElement("b");u.className="node-step",c.append(h,d,u);let f=document.createElement("i");f.className="label-leader",f.style.setProperty("--role-color",l.color),Ie(".scene-labels").append(f,c),cu.set(o.id,f),Ql.set(o.id,c);let g=new qe(new Xr(1.57,.055,8,64),new en({color:ms,emissive:ms,emissiveIntensity:1.5}));g.rotation.x=Math.PI/2,g.scale.set(1,.82,1),g.position.set(o.position[0],.25,o.position[2]),_n.add(g),kf.set(o.id,g)}Cy(),dr=new Zl(An),dr.addPass(new Kl(_n,bt)),dr.addPass(new hr(new te(1024,600),.13,.2,1.9)),dr.addPass(new Jl);let s=new na,r=new te,a;ur.addEventListener("pointerdown",o=>{a=[o.clientX,o.clientY]}),ur.addEventListener("pointerup",o=>{if(!a||Math.hypot(o.clientX-a[0],o.clientY-a[1])>5)return;let l=ur.getBoundingClientRect();r.set((o.clientX-l.left)/l.width*2-1,-(o.clientY-l.top)/l.height*2+1),s.setFromCamera(r,bt);for(let c of s.intersectObject(Ra,!0)){let h=c.object;for(;h&&!h.userData.nodeId;)h=h.parent;if(h){fu(h.userData.nodeId),Rn(!1),Kt();break}}}),fr=!0,ln.dataset.status="ready",ln.dataset.moduleCount=String(lu.size),Ie(".scene-loading").hidden=!0,zf(),Bf(),new ResizeObserver(zf).observe(Ca),requestAnimationFrame(Wf)}catch(i){Xf(i),Zt&&(fr=!0,Bf())}}ln.querySelectorAll("[data-scenario]").forEach(i=>i.addEventListener("click",()=>{Zt&&du(i.dataset.scenario)}));Ie("[data-play]").addEventListener("click",()=>{Rn(!Hn),Mi(),Kt()});for(let[i,e]of[["[data-previous]",-1],["[data-next]",1]])Ie(i).addEventListener("click",()=>{tt&&(Rn(!1),zt=Hf(Math.max(0,Math.min(tt.steps.length-1,ni().index+e))),Mi(!0),Kt())});Ie("#story-progress").addEventListener("input",i=>{tt&&(Rn(!1),zt=Number(i.target.value),Mi(),Kt())});Ie("[data-replay]").addEventListener("click",()=>{tt&&(zt=0,Rn(!0),Mi(!0),Kt())});Ie("#component-select").addEventListener("change",i=>{fu(i.target.value),Rn(!1),Kt()});Ie("[data-reset-camera]").addEventListener("click",()=>{yi=!1,La(),wy()});Ie("[data-cinematic]").addEventListener("click",()=>{yi=!yi,La(),Kt()});Ie("[data-overview]").addEventListener("click",i=>{xi=!xi,i.currentTarget.setAttribute("aria-pressed",String(xi)),tc(),Kt()});Ie("#playback-rate").addEventListener("change",i=>{uu=Number(i.target.value)});function qf(){let i=wn.matches;i!==Uf&&(Uf=i,i&&(yi=!1,Hn=!1),Rt&&(Rt.enableDamping=!Vn&&!i),La(),Mi(),Kt())}wn.addEventListener("change",qf);document.addEventListener("visibilitychange",()=>{$l=0});ur.addEventListener("webglcontextlost",i=>{i.preventDefault(),Xf(new Error("Graphics context was lost"))});var nc=document.querySelector(".film-dialog"),Yf=nc.querySelector("video");Ie("[data-watch-film]").addEventListener("click",()=>{Rn(!1),nc.showModal(),Yf.play().catch(()=>{})});document.querySelector("[data-close-film]").addEventListener("click",()=>nc.close());nc.addEventListener("close",()=>Yf.pause());window.qeArchitecture={get ready(){return fr&&!pr},get snapshot(){return{scenario:tt?.id,stage:jl,elapsed:zt,playing:Hn,cinematic:yi,overview:xi,playbackRate:uu,reducedMotion:wn.matches,node:ni()?.step.node,routes:ni()?.step.routes,modules:lu.size,signals:[...Ia].filter(([,i])=>i.packet.visible).map(([i,e])=>({route:i,position:e.packet.position.toArray()}))}},seek(i,e){return e&&e!==tt.id&&du(e),Rn(!1),zt=Math.max(0,Math.min(vi(),Number(i))),Mi(!0),Kt(),this.snapshot},setCameraCinema(i){yi=!!i&&!wn.matches,Kt()}};Py();
