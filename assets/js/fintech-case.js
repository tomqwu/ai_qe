(() => {
  ...
  function render() {
    ...
    output.querySelector('strong').textContent = step === 4 ? result.pass ? 'Modeled checks passed' : 'Test scenario failed: release blocked' : 'Expected final state';
