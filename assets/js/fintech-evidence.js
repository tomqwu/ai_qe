(() => {
 ...
 exportButton.addEventListener('click',()=>{
  ...
  const lines=['# AI × QE: '+pilot.title,'','Proposed client discussion brief. Client readiness and savings require validation.',''];
