(() => {
 ...
 exportButton.addEventListener('click',()=>{
  ...
  const labels={fit:'When it fits',stack:'Example stack',input:'Client inputs',output:'Deliverable',dependency:'Prerequisites',measure:'Measures',gate:'Acceptance condition',fail:'Pause condition',question:'Discovery question'};
  ...
  lines.push('## Evaluation contract','','Agree scope and acceptance criteria before work begins. Compare matched conventional and assisted tasks using the same foundations. Include failed attempts, review, rework and operating costs. Keep setup and environment wait separate.','',
   ...
   '## Reference material','','Evidence: https://tomqwu.github.io/ai_qe/case-studies/fintech/evidence/','Readiness: https://tomqwu.github.io/ai_qe/platform-readiness/','Harbor is a fictional 75-person scenario; its 12-week sequence and eight-person pilot are planning assumptions.','');
