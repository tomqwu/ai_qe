...
<p><strong>Listen to any briefing.</strong> Open a deck and select <strong>Play narration</strong>. Chris guides you through each slide with English subtitles; the presentation advances when the audio finishes. Pause for discussion, replay a slide or open its transcript at any time. Narration also follows the selected guided route.</p>
