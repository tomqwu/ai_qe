...
- Audio sources are assigned on Play, not during browsing. Pages without narration targets avoid downloading the full narration manifest. Optional Auto-next, the two-second pause, manual takeover, captions and synchronized visual clocks remain intact.
