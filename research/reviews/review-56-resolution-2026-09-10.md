...
- The homepage uses links to full-size decks. The presentation room and case preview use consistent banking deck names; linked outlines reflect real slide headings. Audience filters and embedded deck selection agree across reloads. Readiness search links keep their dependency target visible through late guide rendering and yield immediately to manual scrolling. Dictionary and Downloads remain visible in the desktop rail.
