...
- Audio sources are assigned on Play, not during browsing. Pages without narration targets avoid downloading the full narration manifest. Deferred initialization is cancelled when leaving the page and resumes after an interrupted browser-history restoration. Optional Auto-next, the two-second pause, manual takeover, captions and synchronized visual clocks remain intact.
