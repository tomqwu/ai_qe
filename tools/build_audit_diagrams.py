...
for x,title,line in [(20,'Interpret requirement','Individuals translate intent'),(325,'Write tests','Local prompts + patterns'),(630,'Review change','Reconstruct the evidence'),(935,'Release','Evidence assembled late')]:
...
for x,title,lines in [(20,'Domain contract',('Owner approves behavior','Versioned test oracle')),(325,'Bounded generation',('Permitted context only','Sandbox candidate tests')),(630,'Independent proof',('Original pass / mutant fail','Reviewer owns acceptance')),(935,'Evidence-led release',('Existing change authority','Failure → regression case'))]:
...
for x,title,lines in [(20,'Task envelope',('PAY-042 · payments-api','Contract + context hashes','Scope, deadline, budget')),(325,'Policy decision',('DEC-042 · policy v7','Allow sandbox test only','Identity + expiry binding')),(630,'Evaluation manifest',('EVAL-042 · corpus v3','Original pass / mutant fail','Artifact + runner hashes')),(935,'Evidence record',('RUN-042 · held for review','Links all three artifacts','No self-approval'))]:
