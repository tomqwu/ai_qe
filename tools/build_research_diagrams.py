...
s.node(388,477,336,79,'Curated regression corpus',('Accepted failures + reviewed expectations','New cases challenge the next release'),'node','corpus')
s.path('M 360 516 H 386',link=('evidence', 'corpus'));s.path('M 620 357 V 417 H 25 V 516 H 30','edge edge-dashed',link=('gateway', 'evidence'));s.text(634,417,'run traces','edge-label')
...
s.text(32,590,'Proposed logical architecture · dashed paths carry context, evidence or feedback','small')
s.save()
