...
parent: Governance
nav_order: 2
description: One-page mapping from the controls of a conservative AI-QE and AppSec pilot to the supervisory instruments that expect them.
---
...
|---|---|
| AI-generated tests and code are reviewed and approved by a human before merge; SAST and DAST run on all AI-generated code | B-13 secure SDLC and pre-release scanning; July 2026 bulletin ("validate AI-generated code for vulnerabilities and secure-coding infractions prior to production deployment") |
...
| Sampled audit of AI-dismissed security findings to detect suppressed true positives | April 2026 frontier-AI bulletin (limits on autonomous actions); academic evidence that aggressive false-positive filtering suppresses true vulnerabilities |
