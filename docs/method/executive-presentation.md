...
| 3. What the external evidence actually says | 10 min | One slide: task gains exist (vendor and lab), the independent randomized study was negative, telemetry shows a stability risk, consultancies say gains are rarely monetized; one slide: what could not be verified | Credibility; pre-empts "the analysts say" |
