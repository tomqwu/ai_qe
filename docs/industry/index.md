...
Start with [Strategic choices]({{ "/docs/industry/strategic-choices/" | relative_url }}) for the Executive narrative, [Reference contracts]({{ "/docs/industry/reference-contracts/" | relative_url }}) for the technical example, and [Coverage and method]({{ "/docs/industry/coverage/" | relative_url }}) to assess research gaps. The [library]({{ "/docs/industry/library/" | relative_url }}) is the canonical source register; older evidence notes retain historical detail. [Versioned audience PDFs]({{ "/releases/" | relative_url }}) match the current slide edition.
